...
# ══════════════════════════════════════════════════════════════
EMAIL_REMETENTE   = "seuemail@gmail.com"        # conta Gmail que vai enviar
SENHA_APP         = "xxxx xxxx xxxx xxxx"       # Senha de App do Gmail (NÃO é a senha normal!)
NOME_REMETENTE    = "Hapvida Odonto"            # nome que aparece no campo "De:"

ASSUNTO           = "Comunicado Hapvida Odonto" # assunto do e-mail (aceita {{PLACEHOLDERS}})
